...
public class MinNum_1203 {
    public static void main(String[] args) {
        ...
        // 5. 최솟값과 최솟값이 저장된 행, 열의 위치를 기억할 변수
        // - 난수의 범위가 1~100이므로 최솟값의 초기값을 101로 설정
        int min = 101;
        int minRow = 0;
        int minColumn = 0;
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                ...
                // 7. [조건 4] 현재 값이 저장된 최솟값보다 작은 경우에만 갱신
        ...
        // 10. [조건 4, 5] 최솟값과 가장 먼저 발견한 최솟값의 위치 출력
        // - 배열의 위치는 0번부터 시작하며 (행, 열) 순서로 표시
        System.out.println("최솟값 : " + min);
        System.out.println("최솟값의 위치 : (" + minRow + ", " + minColumn + ")");
